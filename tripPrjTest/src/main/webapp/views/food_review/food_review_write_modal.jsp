...
<body>
	...
	<!-- 리뷰 작성폼 -->
	<form class="needs-validation" id="reviewFormValue"
		enctype="multipart/form-data" name="form" method="post"
		action="foodReviewWrite">
		<input type="hidden" name="id" value="${sessionScope.id }"> <input
			type="hidden" name="food_id" value="${food_id }"> <input
		...
		<div class="mb-4">
			...
			<textarea class="form-control" id="rev_content" name="rev_content"
				rows="5" placeholder="리뷰 내용" required></textarea>
			<div class="invalid-feedback">리뷰를 작성해주세요.</div>
		</div>
		<div class="mb-4">
			<input class="form-control" type="file" name="rev_photos"
				id="rev_photos" multiple="multiple">
		</div>
