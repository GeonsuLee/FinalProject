...
function modify(place_rev_id){
	 $('#modifyform').load('placeReviewModifyModal?place_rev_id='+place_rev_id);
 }
 

function writes(place_id){
	 $('#writeform').load('placeReviewWriteModal?place_id='+place_id);
 }
 
 function reply(place_rev_id){
	 $('#replyform').load('placeReplyWriteModal?place_rev_id='+place_rev_id);
 }


function replyList(place_rev_id){
	 
	 $('#seeMoreOverview_'+place_rev_id).load('placeReplyList?place_rev_id='+place_rev_id);
        ...
        <div class="row">
          <div class="col-md-7 mb-md-0 mb-4">
            ...
            <div class="mb-4 pb-4 border-bottom">
              ...
              <button class="btn btn-outline-primary mb-sm-0 mb-3" href="#modal-review" data-bs-toggle="modal" onclick="writes(${place_id})">
			...
			<c:forEach var="placeReview" items="${placeReviewList}">
	            ...
	            <div class="mb-4 pb-4 border-bottom">
	              ...
	              <div class="d-flex justify-content-between mb-3">
	                <div class="d-flex align-items-center pe-2"><img class="rounded-circle me-1" src="img/avatars/16.png" width="48" alt="Avatar">
	                  ...
	                  <div class="starpoint_wraps">
	                    ...
	                    <h6 class="fs-base mb-0">${placeReview.id}</h6> </div>
	                </div><span class="text-muted fs-sm">${placeReview.rev_reg}</span>
	              </div>
	              ...
	              <div class="d-flex justify-content-between align-items-center">
	                ...
	                onclick="reply(${placeReview.place_rev_id })">
	                <i class="fi-reply fs-lg me-2"></i><span class="fw-normal">댓글</span></button>
	              </div>
	              
	              <div class="d-flex justify-content-between align-items-center">
	                <div class="d-flex align-items-center pe-2"></div>
	                <button class="btn btn-link btn-sm" type="button"  id="test1"  href="#modal-review-modify"  data-bs-toggle="modal" value="${placeReview.place_rev_id }" onclick="modify(${placeReview.place_rev_id })">
	              ...
	              <div class="d-flex justify-content-between align-items-center">
	                <div class="d-flex align-items-center pe-2"></div>
	                 <button type="button" value="삭제" class="btn btn-link btn-sm" onclick="location='placeReviewDelete?place_rev_id=${placeReview.place_rev_id}'" >
	                <i class="fi-reply fs-lg me-2"></i><span class="fw-normal">삭제</span></button>     
	              </div>
	              <a class="collapse-label collapsed" href="#seeMoreOverview_${placeReview.place_rev_id}" data-bs-toggle="collapse" data-bs-label-collapsed="댓글 보기" data-bs-label-expanded="접기" role="button" aria-expanded="false" aria-controls="seeMoreOverview" 
                  	onclick="replyList(${placeReview.place_rev_id })"></a>
                 
	                
	               
	                
              <!-- Reply to comment-->
              <div class="collapse" id="seeMoreOverview_${placeReview.place_rev_id}">
            ...
            <nav class="mt-2 mb-4" aria-label="Reviews pagination">
              <ul class="pagination">
                ...
                <c:forEach var="a" begin="${startPage}" end="${endPage}">
					...
					<c:if test="${a != page }">
						<li class="page-item d-none d-sm-block"><a class="page-link" href="placeReviewList?page=${a}"><span class="page-link">${a}<span class="visually-hidden"></span></span></a></li>
					</c:if>
                </c:forEach>
