      ...
      <div class="container pt-5 pb-lg-4 mt-5 mb-sm-2">
        ...
        <nav class="mb-4 pt-md-3" aria-label="Breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="real-estate-account-info.html">계정</a></li>
        ...
        <div class="row">
          ...
          <aside class="col-lg-4 col-md-5 pe-xl-4 mb-5">
            ...
            <div class="card card-body border-0 shadow-sm pb-1 me-lg-1">
              <div class="d-flex d-md-block d-lg-flex align-items-start pt-lg-2 mb-1"><img class="rounded-circle" src="img/avatars/13.png" width="48" alt="아이디">
                <div class="pt-md-2 pt-lg-0 ps-3 ps-md-0 ps-lg-3">
                  <h2 class="fs-lg mb-0">아이디</h2>
                  <ul class="list-unstyled fs-sm mt-3 mb-0">
                    <li><a class="nav-link fw-normal p-0" href="tel:3025550107"><i class="fi-phone opacity-60 me-2"></i>연락처</a></li>
                    <li><a class="nav-link fw-normal p-0" href="mailto:annette_black@email.com"><i class="fi-mail opacity-60 me-2"></i>이메일</a></li>
                  </ul>
                </div>
              </div>
              ...
              <div class="pb-4 mb-1">
                ...
                <div class="text-center text-md-start"><a class="collapse-label collapsed fs-sm" href="#seeMore" data-bs-toggle="collapse" data-bs-label-collapsed="더보기" data-bs-label-expanded="접기" role="button" aria-expanded="false" aria-controls="seeMore"></a></div>
              </div>
              
              <div class="collapse d-md-block mt-3" id="account-nav">
                <div class="card-nav">
                  <a class="card-nav-link active" href="real-estate-account-info.html"><i class="fi-user opacity-60 me-2"></i>개인 정보</a>
                  <a class="card-nav-link" href="real-estate-account-properties.html"><i class="fi-bed opacity-60 me-2"></i>예약내역</a>
                  <a class="card-nav-link" href="real-estate-account-wishlist.html"><i class="fi-bookmark opacity-60 me-2"></i>북마크</a>
                  <a class="card-nav-link" href="real-estate-account-reviews.html"><i class="fi-star opacity-60 me-2"></i>리뷰</a>
                  <a class="card-nav-link" href="real-estate-help-center.html"><i class="fi-help opacity-60 me-2"></i>Q&A</a>
                  <a class="card-nav-link" href="signin-light.html"><i class="fi-logout opacity-60 me-2"></i>로그아웃</a></div>
              </div>
            </div>
          </aside>
          <!-- Content-->
          <div class="col-lg-8 col-md-7 mb-5">
            ...
            <div class="row pb-2">
              <div class="col-lg-9 col-sm-8 mb-4">
                <textarea class="form-control" id="account-bio" rows="6" placeholder="세부사항 작성"></textarea>
              </div>
              <div class="col-lg-3 col-sm-4 mb-4">
                <input class="file-uploader bg-secondary" type="file" accept="image/png, image/jpeg" data-label-idle="&lt;i class=&quot;d-inline-block fi-camera-plus fs-2 text-muted mb-2&quot;&gt;&lt;/i&gt;&lt;br&gt;&lt;span class=&quot;fw-bold&quot;&gt;프로필 사진 변경&lt;/span&gt;" data-style-panel-layout="compact" data-image-preview-height="160" data-image-crop-aspect-ratio="1:1" data-image-resize-target-width="200" data-image-resize-target-height="200">
              </div>
            </div>
            <div class="border rounded-3 p-3 mb-4" id="personal-info">
              ...
              <div class="border-bottom pb-3 mb-3">
                ...
                <div class="collapse" id="password-collapse" data-bs-parent="#auth-info">
                  ...
                  <div class="row gx-3 align-items-center my-3">
                    <label class="col-sm-4 col-md-3 col-form-label" for="account-password-new">새로운 비밀번호 :</label>
                    <div class="col-sm-8 col-md-9">
                      <div class="password-toggle">
                  ...
                  <div class="row gx-3 align-items-center">
                    <label class="col-sm-4 col-md-3 col-form-label" for="account-password-confirm">새로운 비밀번호 확인 :</label>
                    <div class="col-sm-8 col-md-9">
                      <div class="password-toggle">
            ...
            <div class="d-flex align-items-center justify-content-between mt-4 pt-4 pb-1">
              <button class="btn btn-primary px-3 px-sm-4" type="button">프로필 수정</button>
              <button class="btn btn-link btn-sm px-0" type="button"><i class="fi-trash me-2"></i>회원 탈퇴</button>
            </div>
          </div>
        </div>
      </div>
