...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<!-- load함수로 불러옴 -->	
      ...
      <c:forEach var="roomReview" items="${reviewlist}">
	            ...
	            <div class="mb-4 pb-4 border-bottom">
	              ...
	              <div class="d-flex justify-content-between mb-3">
	                ...
	                <img class="rounded-circle me-1" src="<%=request.getContextPath()%>/upload/${roomReview.userphoto}" width="48" alt="Avatar">
	                </c:if>
	                <c:if test="${empty roomReview.userphoto}">
	                <img class="rounded-circle me-1" src="img/avatars/16.png" width="48" alt="Avatar">
	                  ...
	                  <div class="starpoint_wraps">
		                  ...
		                  <button type="button" class="dropdown-item" onclick="roomlike(${roomReview.room_rev_id},${room_id },${page })" value="${sessionScope.id }" id="sessionScopeId">
	              ...
	              <div class="d-flex justify-content-between align-items-center">
	                ...
	                onclick="reply(${roomReview.room_rev_id },${page },${roomReview.room_id })">
                ...
                <div class="mb-4 pb-4 border-bottom">
                    <div class="d-flex justify-content-between mb-3">
                        <div class="d-flex align-items-center pe-2"><img class="rounded-circle me-1" src="img/avatars/16.png" width="48" alt="Avatar">
                            <div class="ps-2">
                                <h6 class="fs-base mb-0">${room_id}</h6>
