...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<!-- load함수로 불러옴 -->	
      ...
      <c:forEach var="placeReview" items="${reviewlist}">
	            ...
	            <div class="mb-4 pb-4 border-bottom">
	              ...
	              <div class="d-flex justify-content-between mb-3">
	                ...
	                <img class="rounded-circle me-1" src="<%=request.getContextPath()%>/upload/${placeReview.userphoto}" width="48" alt="Avatar">
	                </c:if>
	                <c:if test="${empty placeReview.userphoto}">
	                <img class="rounded-circle me-1" src="img/avatars/16.png" width="48" alt="Avatar">
	                  ...
	                  <div class="starpoint_wraps">
		                  ...
		                  <button type="button" class="dropdown-item" onclick="placelike(${placeReview.place_rev_id},${place_id },${page })" value="${sessionScope.id }" id="sessionScopeId">
	              ...
	              <div class="d-flex justify-content-between align-items-center">
	                ...
	                onclick="reply(${placeReview.place_rev_id },${page },${placeReview.place_id })">
            ...
            <%@ include file="../place/qna_modal.jsp" %>
                ...
                <div class="mb-4 pb-4 border-bottom">
                    <div class="d-flex justify-content-between mb-3">
                        <div class="d-flex align-items-center pe-2"><img class="rounded-circle me-1" src="img/avatars/16.png" width="48" alt="Avatar">
                            <div class="ps-2">
                                <h6 class="fs-base mb-0">${place_id}</h6>
